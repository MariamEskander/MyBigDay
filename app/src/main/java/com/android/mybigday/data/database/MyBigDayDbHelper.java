...
public class MyBigDayDbHelper {

   private static final String DATABASE_NAME ="albawaba.db";
    private static final int DATABASE_VERSION =1;

    public static MyBigDayDbHelper instance;
     ...
     */
    public static MyBigDayDbHelper GetFor(Context context) {
        if (instance == null)
            instance = new MyBigDayDbHelper(context);
        return instance;
    }

    public MyBigDayDbHelper(Context _context) {
    ...
    public boolean open() {
        ...
        while (!GlobalVariables.lc.tryLock()) {
    ...
    public static class DbOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            final String SQL_CREATE_TODO_TABLE = "CREATE TABLE " +
                    MyBigDayContract.TodoEntry.TABLE_NAME + " ( " +
                    MyBigDayContract.TodoEntry._ID + "  INTEGER PRIMARY KEY AUTOINCREMENT , " +
                    MyBigDayContract.TodoEntry.COLUMN_TODO_ID + "  INTEGER NOT NULL UNIQUE , " +
                    MyBigDayContract.TodoEntry.COLUMN_TODO_TEXT + " TEXT NOT NULL " + " );";

            final String SQL_CREATE_PLAN_TABLE = "CREATE TABLE " +
                    MyBigDayContract.PlanEntry.TABLE_NAME + " ( " +
                    MyBigDayContract.PlanEntry._ID + "  INTEGER PRIMARY KEY AUTOINCREMENT , " +
                    MyBigDayContract.PlanEntry.COLUMN_NAME + "  TEXT NOT NULL , " +
                    MyBigDayContract.PlanEntry.COLUMN_PlACE + "  TEXT NOT NULL , " +
                    MyBigDayContract.PlanEntry.COLUMN_GUEST + "  TEXT NOT NULL , " +
                    MyBigDayContract.PlanEntry.COLUMN_COST + " TEXT NOT NULL " + " );";
            try {
        ...
        public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
            sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + MyBigDayContract.TodoEntry.TABLE_NAME);
            sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + MyBigDayContract.TodoEntry.TABLE_NAME);
